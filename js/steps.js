// Steps data with actual content from help.html
        const stepsData = {
            ...
            'perform-paytech-payments': {
                ...
                steps: [
                    "perform-paytech-payments-step1",
                    "perform-paytech-payments-step2",
                    "perform-paytech-payments-step3",
                    "perform-paytech-payments-step4",
                    "perform-paytech-payments-step5",
            ...
            'perform-paypal-payments': {
                ...
                steps: [
                    "perform-paypal-payments-step1",
                    "perform-paypal-payments-step2",
                    "perform-paypal-payments-step3",
            ...
            'buyer-referral-program': {
                ...
                steps: [
                    "buyer-referral-program-step1",
                    "buyer-referral-program-step2",
                    "buyer-referral-program-step3",
                    "buyer-referral-program-step4",
                    "buyer-referral-program-step5",
