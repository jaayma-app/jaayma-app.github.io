const fr = {
    ...
    'perform-paytech-payments': 'Comment effectuer des paiements?',
    'perform-paytech-payments-desc': 'Méthodes de paiement sécurisées et guides de transaction',
    'perform-paypal-payments': 'Comment effectuer des paiements?',
    ...
    'paypal-upload-auth': 'Comment obtenir les autorisations de téléchargement?',
    'paypal-upload-auth-desc': 'Vérifiez votre compte pour les privilèges de vente',
    'paytech-upload-auth': 'Comment obtenir les autorisations de téléchargement?',
